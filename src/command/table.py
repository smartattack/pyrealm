...
cmd_table.append(CT('up',          'do_go',      'standing',  0, 'up'))
cmd_table.append(CT('down',        'do_go',      'standing',  0, 'down'))
cmd_table.append(CT('ne',          'do_go',      'standing',  0, 'northeast'))
cmd_table.append(CT('nw',          'do_go',      'standing',  0, 'northwest'))
cmd_table.append(CT('se',          'do_go',      'standing',  0, 'southeast'))
cmd_table.append(CT('sw',          'do_go',      'standing',  0, 'southwest'))
...
cmd_table.append(CT('look',        'do_look',    'dead',      0, None))
cmd_table.append(CT('examine',     'do_look',    'dead',      0, None))
...
cmd_table.append(CT('shutdown',    'do_shutdown','dead',    100, None))
