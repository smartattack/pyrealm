...
Contains one class, Server, which can be instantiated to start a
...
class Server(object):
    ...
    def __init__(self):
        """Constructs the Server object and starts listening for
        new players.
        """
    ...
    def _check_for_new_connections(self):
        ...
        self._clients[self._nextid] = Server._Client(joined_socket, addr[0],
                                                        "", time.time())
