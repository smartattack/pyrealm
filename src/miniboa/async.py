...
class TelnetServer(object):
    ...
    def poll(self):
        ...
        ## Handle sockets that disconnected
        for sock_fileno in elist:
            log.info("Socket exception for {}".format(self.clients[sock_fileno].addrport()))
            self.clients[sock_fileno].active == False
